"""
API服务 v3 - 纯Prompt文献综述生成方案（章节+引用增强）
"""
import os
import json
import time
...
from review_generator_v3 import ReviewGeneratorV3
from prompt_template_v3 import detect_language
...
# 创建FastAPI应用
app = FastAPI(
    title="ICAIS2025-LiteratureReview API v3",
    version="3.0.0",
    docs_url="/docs",
    redoc_url="/redoc"
)
    ...
    try:
        ...
        if language == 'zh':
            ...
            msg_templates = {
                ...
                'final_title': "## 📄 Literature Review (v3)\n\n",
        ...
        generator = ReviewGeneratorV3(llm_client, language=language)
...
async def health_check():
    """健康检查端点"""
    return {"status": "ok", "service": "ICAIS2025-LiteratureReview API v3", "version": "3.0.0"}
...
if __name__ == "__main__":
    ...
    print(f"🚀 启动 ICAIS2025-LiteratureReview API v3 服务...")
